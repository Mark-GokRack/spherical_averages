...
#ifndef BEATRICE_COMMON_SPHERICAL_AVERAGE_LBFGS_H_
#define BEATRICE_COMMON_SPHERICAL_AVERAGE_LBFGS_H_
...
class SphericalAverageLBFGS {
 public:
  ...
  SphericalAverageLBFGS(size_t num_point_all, size_t num_feature,
                        const T* unnormalized_vectors,
                        size_t num_point_limit = 0, size_t num_memory = 4)
...
#endif  // BEATRICE_COMMON_SPHERICAL_AVERAGE_LBFGS_H_
